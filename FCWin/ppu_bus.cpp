...
PictureBus::PictureBus(){
    memset(ram_data, 0, sizeof(uint8_t) * 0x400);// 两个和名称表：2000 到 23FF ;
    memset(ram_data_2, 0, sizeof(uint8_t) * 0x400);// 2400 到 27FF
    memset(palette_data, 0, sizeof(uint8_t) * 0x20); //图样表 单位32kb
}
